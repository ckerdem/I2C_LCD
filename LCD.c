...
#define LCD_aydinla 8U
    ...
    /*
     LCD'ye veri gönderir. Kumut için RS=0, yazi için RS=LCD_RS olmalidir.
     */
    ...
    /*  LCD ekrani baslatir. Önce bu fonksiyon çairslmalidir.  */
    ...
    /*	 Imleçi verilen satir sütun numarasina götürür  */
...
void lcd_git(uint8_t satir, uint8_t sutun) {
 ...
 /*	Verilen satir sütun numarasindan baslayarak ekrana mesaj yazar*/
